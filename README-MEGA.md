...
3. `absolute_position` corrected. Upstream subtracts a node's **own** scroll offset from
   ...
   container with `scrollLeft = 80` reported its left edge as `8 - 80`. **This one is
